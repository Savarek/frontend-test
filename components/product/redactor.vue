    ...
    <form class="redactor-form">
      <div class="redactor-option">
        ...
        <input
          v-model="name"
          :class="{
            error: !$v.name.required && isNameRequired,
            error: !$v.name.validFormat && isNameRequired,
          }"
          type="text"
          class="redactor-option__input"
          placeholder="Введите наименование товара"
          @focus="isNameRequired = true"
        />
        <p v-if="!$v.name.required && isNameRequired" class="error-message">
          Поле является обязательным
        </p>
        <p
          v-else-if="!$v.name.validFormat && isNameRequired"
          class="error-message"
        >
      ...
      <div class="redactor-option">
        ...
        <input
          v-model="img"
          :class="{
            error: !$v.img.required && isImgRequired,
            error: !$v.img.validFormat && isImgRequired,
          }"
          type="text"
          class="redactor-option__input"
          placeholder="Введите ссылку"
          @focus="isImgRequired = true"
        />
        <p v-if="!$v.img.required && isImgRequired" class="error-message">
          Поле является обязательным
        </p>
        <p
          v-else-if="!$v.img.validFormat && isImgRequired"
          class="error-message"
        >
      ...
      <div class="redactor-option">
        ...
        <input
          v-model="price"
          :class="{
            error: !$v.price.required && isPriceRequired,
            error: !$v.price.validFormat && isPriceRequired,
          }"
          type="text"
          class="redactor-option__input"
          placeholder="Цена товара"
          @focus="isPriceRequired = true"
        />
        <p v-if="!$v.price.required && isPriceRequired" class="error-message">
          Поле является обязательным
        </p>
        <p
          v-else-if="!$v.price.validFormat && isPriceRequired"
          class="error-message"
        >
